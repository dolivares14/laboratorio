...
<div class="container bg-light" style="margin-top:5%;margin-bottom:8%">
        <table class="table table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $fquery['user'];?></td>
                    <td><?php echo $fquery['password'];?></td>
                    <td><?php echo $fquery['nombre']." ".$fquery['apellido'];?></td>
                    <td><?php echo $fquery['telf'];?></td>
                    <td><?php echo $fquery['correo'];?></td>
                    <td><?php echo $fquery['clase'];?></td>
                    <td><a class="btn btn-outline-primary" href="muser.php?ID=<?php echo $fquery['ID'];?>">Modificar usuario</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
        <a class="btn btn-outline-primary" href="nuser.php">Nuevo usuario</a>
        <?php 
          mysqli_close($con); 
        ?>
    </div>
