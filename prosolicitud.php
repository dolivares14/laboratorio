            ...
            <div class="card text-dark bg-light mb-3 mr-3" style="max-width: 18rem;" style="margin-right:2%;">
               ...
               <div class="card-body">
                      ...
                      <span class="badge badge-dark">En espera</span>
                            ...
                            <?php
                            if($fquery['tipo']=="Heces"){
                                ?>
                                <a class="btn btn-outline-primary" href="formheces.php?ID=<?php echo $fquery['ID_examen']?>">Procesar solicitud</a>
                                <?php                            
                            }elseif($fquery['tipo']=="Hematologia"){
                                ?>
                                <a class="btn btn-outline-primary" href="formhematologia.php?ID=<?php echo $fquery['ID_examen']?>">Procesar solicitud</a>
                                <?php                            
                            }elseif($fquery['tipo']=="Orina"){
                                ?>
                                <a class="btn btn-outline-primary" href="formorina.php?ID=<?php echo $fquery['ID_examen']?>">Procesar solicitud</a>
                                <?php                            
                            }elseif($fquery['tipo']=="Bioquimica"){
                                ?>
                                <a class="btn btn-outline-primary" href="formbioquimica.php?ID=<?php echo $fquery['ID_examen']?>">Procesar solicitud</a>
                                <?php                            
                            }
                            ?>
                             </div>
