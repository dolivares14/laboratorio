...
<head>
 ...
 <title>Lista de solicitudes realizadas</title>
</head>
<body>
...
<div class="parallaxdoc2">
    ...
    <?php
        ...
        while($fquery=mysqli_fetch_array($rsquery)){
            if($fquery['ID_doctor']==$_SESSION['iddoc']){
                   ...
                   <div class="card-body">
                      ...
                      $idexamen=$fquery['ID_examen'];
                         if($fquery['estado']=="En espera"){
                             ...
                             <a href="procesos/retirarsolicitud.php?id=<?php echo $idexamen;?>&location=doc" class="btn btn-outline-danger">Retirar solicitud</a>
                             </div>
                             <?php
